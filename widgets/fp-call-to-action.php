...
class domestication_Action extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'domestication_action_widget', 'description' => __( 'Display a call to action block.', 'domestication') );
        parent::__construct(false, $name = __('domestication FP: Call to action', 'domestication'), $widget_ops);
		$this->alt_option_name = 'domestication_action_widget';
    }
	...
	?>
	<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'domestication'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></p>
	<p><label for="<?php echo $this->get_field_id('action_text'); ?>"><?php _e('Enter your call to action.', 'domestication'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_link'); ?>"><?php _e('Link for the button', 'domestication'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_text'); ?>"><?php _e('Title for the button', 'domestication'); ?></label>
	...
	<label for="<?php echo $this->get_field_id( 'inline' ); ?>"><?php _e( 'Display the button inline with the text?', 'domestication' ); ?></label></p>
	<?php
	}
	...
	function update($new_instance, $old_instance) {
		...
		if ( isset($alloptions['domestication_action']) )
			delete_option('domestication_action');		  
	...
	function widget($args, $instance) {
		$cache = array();
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'domestication_action', 'widget' );
		}
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'domestication_action', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	}
