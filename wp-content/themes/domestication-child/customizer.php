...
function domestication_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting(
        'slider_title_1',
        array(
            'default' => __('Welcome to domestication','domestication'),
    ...
    $wp_customize->add_control(
        'slider_title_1',
        array(
            'label' => __( 'Title for the first slide', 'domestication' ),
            'section' => 'domestication_slider',
            'type' => 'text',
            'priority' => 12
        )
    ...
    $wp_customize->add_setting(
        'slider_subtitle_1',
        array(
            'default' => __('Feel free to look around','domestication'),
            'sanitize_callback' => 'domestication_sanitize_text',
        )
    );
    $wp_customize->add_control(
        'slider_subtitle_1',
        array(
            'label' => __( 'Subtitle for the first slide', 'domestication' ),
            'section' => 'domestication_slider',
            'type' => 'text',
            'priority' => 13
        )
