...
jQuery("#form-option").submit(function(e)
{
	...
	jQuery.ajax(
	{
		...
		jQuery( ".themeoption-themes .btn-save input" ).addClass( "save-details" );
		jQuery(".themeoption-themes .btn-save input").val('Options saved successfully');
		setTimeout(function () {
            jQuery( ".themeoption-themes .btn-save input" ).removeClass( "save-details" );
            jQuery(".themeoption-themes .btn-save input").val('Save options');
