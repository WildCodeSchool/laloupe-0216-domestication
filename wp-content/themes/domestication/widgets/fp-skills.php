...
class domestication_Skills extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'domestication_skills_widget', 'description' => __( 'Show your visitors some of your skills.', 'domestication') );
        parent::__construct(false, $name = __('domestication FP: Skills', 'domestication'), $widget_ops);
		$this->alt_option_name = 'domestication_skills_widget';
    }
	...
	<!-- skill one -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_one'); ?>"><?php _e('First skill name', 'domestication'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_one_max'); ?>"><?php _e('First skill value', 'domestication'); ?></label>
	...
	<!-- skill two -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_two'); ?>"><?php _e('Second skill name', 'domestication'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_two_max'); ?>"><?php _e('Second skill value', 'domestication'); ?></label>
	...
	<!-- skill three -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_three'); ?>"><?php _e('Third skill name', 'domestication'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_three_max'); ?>"><?php _e('Third skill value', 'domestication'); ?></label>
	...
	<!-- skill four -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_four'); ?>"><?php _e('Fourth skill name', 'domestication'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_four_max'); ?>"><?php _e('Fourth skill value', 'domestication'); ?></label>
	...
	function update($new_instance, $old_instance) {
		...
		if ( isset($alloptions['domestication_skills']) )
			delete_option('domestication_skills');		  
	...
	function widget($args, $instance) {
		$cache = array();
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'domestication_skills', 'widget' );
		}
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'domestication_skills', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	}
