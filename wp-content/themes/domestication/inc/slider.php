...
//Slider template
if ( ! function_exists( 'domestication_slider_template' ) ) :
function domestication_slider_template() {
    ...
    if ( !function_exists('pll_register_string') ) {
        $slider_title_1     = get_theme_mod('slider_title_1', 'Welcome to domestication');
        ...
        $slider_subtitle_12  = get_theme_mod('slider_subtitle_12','Feel free to look around');
        $slider_subtitle_13  = get_theme_mod('slider_subtitle_13','Feel free to look around');
        $slider_subtitle_14  = get_theme_mod('slider_subtitle_14','Feel free to look around');
        $slider_subtitle_15  = get_theme_mod('slider_subtitle_15','Feel free to look around');
        ...
        $slider_title_1     = pll__(get_theme_mod('slider_title_1', 'Welcome to domestication'));
    ...
    <div id="slideshow" class="header-slider" data-speed="<?php echo esc_attr($speed); ?>">
        ...
        <!--<div class="testopacite">
            tetet
        </div> -->       

        <div class="text-slider-section testopacite">
            <div class="text-slider" data-speed="<?php echo esc_attr($text_speed); ?>" data-slideshow="<?php echo esc_attr($slide_toggle); ?>">
                <ul class="slide-text slides">
                    ...
                    <li>
                        <div class="contain">
                            <div class="colloque"><?php echo esc_html($slider_subtitle_12); ?></div>
                            <h2 class="titre"><?php echo esc_html($slider_title_1); ?></h2>
                            <p class="soutitre"><?php echo esc_html($slider_subtitle_1); ?></p>
                            
                            <div class="lieu1"><?php echo esc_html($slider_subtitle_13); ?></div>
                            <div class="lieu2"><?php echo esc_html($slider_subtitle_14); ?></div>
                            <div class="dates"><?php echo esc_html($slider_subtitle_15); ?></div>
                        </div>
                    </li>
                    <?php endif; ?>
