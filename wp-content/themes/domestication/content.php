...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( has_post_thumbnail() && ( get_theme_mod( 'index_feat_image' ) != 1 ) ) : ?>
		<div class="entry-thumb">
			<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_post_thumbnail('domestication-large-thumb'); ?></a>
		</div>
	<?php endif; ?>
	...
	<div class="entry-post">
		...
		<?php
			wp_link_pages( array(
				'before' => '<div class="page-links">' . __( 'Pages:', 'domestication' ),
				'after'  => '</div>',
			) );
		?>
	</div><!-- .entry-post -->
	...
	<footer class="entry-footer">
		<?php domestication_entry_footer(); ?>
	</footer><!-- .entry-footer -->
</article><!-- #post-## -->