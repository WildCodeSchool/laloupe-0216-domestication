...
Best is distributed under the terms of the GNU GPL
...
Everything else used in this theme has been created by BestWebSoft, especially for the *Best* theme and is distributed under GPL license.

== Installation ==

Manual installation:

1. Upload the `Best` folder to `/wp-content/themes/` directory
