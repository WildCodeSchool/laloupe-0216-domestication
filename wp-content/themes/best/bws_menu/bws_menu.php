...
if ( ! function_exists( 'bws_add_themes_menu_render' ) ) {
	function bws_add_themes_menu_render() {
		global $wpdb, $wp_version, $bws_theme_info;
		...
		$path = get_template_directory_uri() . '/bws_menu/';
		...
		$bws_plugins = array(
			'captcha/captcha.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/captcha/?k=d678516c0990e781edfb6a6c874f0b8a&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/captcha/download/?k=d678516c0990e781edfb6a6c874f0b8a&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase'		=> 'http://bestwebsoft.com/products/captcha/buy/?k=ff7d65e55e5e7f98f219be9ed711094e&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'contact-form-plugin/contact_form.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/contact-form/?k=012327ef413e5b527883e031d43b088b&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/contact-form/download/?k=012327ef413e5b527883e031d43b088b&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase'		=> 'http://bestwebsoft.com/products/contact-form/buy/?k=773dc97bb3551975db0e32edca1a6d71&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'facebook-button-plugin/facebook-button-plugin.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/facebook-like-button/?k=05ec4f12327f55848335802581467d55&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/facebook-like-button/download/?k=05ec4f12327f55848335802581467d55&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase' 		=> 'http://bestwebsoft.com/products/facebook-like-button/buy/?k=8da168e60a831cfb3525417c333ad275&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'twitter-plugin/twitter.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/twitter/?k=f8cb514e25bd7ec4974d64435c5eb333&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/twitter/download/?k=f8cb514e25bd7ec4974d64435c5eb333&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase' 		=> 'http://bestwebsoft.com/products/twitter/buy/?k=63ecbf0cc9cebf060b5a3c9362299700&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'portfolio/portfolio.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/portfolio/?k=1249a890c5b7bba6bda3f528a94f768b&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/portfolio/download/?k=1249a890c5b7bba6bda3f528a94f768b&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'gallery-plugin/gallery-plugin.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/gallery/?k=2da21c0a64eec7ebf16337fa134c5f78&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/gallery/download/?k=2da21c0a64eec7ebf16337fa134c5f78&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase'		=> 'http://bestwebsoft.com/products/gallery/buy/?k=382e5ce7c96a6391f5ffa5e116b37fe0&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'adsense-plugin/adsense-plugin.php'=> array(
				...
				'link'			=> 'http://bestwebsoft.com/products/google-adsense/?k=60e3979921e354feb0347e88e7d7b73d&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/google-adsense/download/?k=60e3979921e354feb0347e88e7d7b73d&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'custom-search-plugin/custom-search-plugin.php'=> array(
				...
				'link'			=> 'http://bestwebsoft.com/products/custom-search/?k=933be8f3a8b8719d95d1079d15443e29&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/custom-search/download/?k=933be8f3a8b8719d95d1079d15443e29&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'quotes-and-tips/quotes-and-tips.php'=> array(
				...
				'link'			=> 'http://bestwebsoft.com/products/quotes-and-tips/?k=5738a4e85a798c4a5162240c6515098d&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/quotes-and-tips/download/?k=5738a4e85a798c4a5162240c6515098d&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'google-sitemap-plugin/google-sitemap-plugin.php'=> array(
				...
				'link'			=> 'http://bestwebsoft.com/products/google-sitemap/?k=5202b2f5ce2cf85daee5e5f79a51d806&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/google-sitemap/download/?k=5202b2f5ce2cf85daee5e5f79a51d806&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase'		=> 'http://bestwebsoft.com/products/google-sitemap/buy/?k=7ea384a5cc36cb4c22741caa20dcd56d&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'updater/updater.php'=> array(
				...
				'link'			=> 'http://bestwebsoft.com/products/updater/?k=66f3ecd4c1912009d395c4bb30f779d1&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products
pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'contact-form-multi/contact-form-multi.php' => array(
				...
				'description'	=> 'This plugin allows you to subscribe users for newsletters from your website.',
				'link'			=> 'http://bestwebsoft.com/products/contact-form-multi/?k=83cdd9e72a9f4061122ad28a67293c72&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/contact-form-multi/download/?k=83cdd9e72a9f4061122ad28a67293c72&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase' 		=> 'http://bestwebsoft.com/products/contact-form-multi/buy/?k=fde3a18581c143654f060c398b07e8ac&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'pro_settings' 	=> ''
			),
			'bws-google-maps/bws-google-maps.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/bws-google-maps/?k=d8fac412d7359ebaa4ff53b46572f9f7&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/bws-google-maps/download/?k=d8fac412d7359ebaa4ff53b46572f9f7&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase' 		=> 'http://bestwebsoft.com/products/bws-google-maps/buy/?k=117c3f9fc17f2c83ef430a8a9dc06f56&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'bws-google-analytics/bws-google-analytics.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/bws-google-analytics/?k=261c74cad753fb279cdf5a5db63fbd43&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/bws-google-analytics/download/?k=261c74cad753fb279cdf5a5db63fbd43&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'db-manager/db-manager.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/db-manager/?k=01ed9731780d87f85f5901064b7d76d8&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/db-manager/download/?k=01ed9731780d87f85f5901064b7d76d8&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'wp_install'	=> 'http://bestwebsoft.com/products/db-manager/download/?k=01ed9731780d87f85f5901064b7d76d8&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'user-role/user-role.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/user-role/?k=dfe2244835c6fbf601523964b3f34ccc&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/user-role/download/?k=dfe2244835c6fbf601523964b3f34ccc&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase' 		=> 'http://bestwebsoft.com/products/user-role/buy/?k=cfa9cea6613fb3d7c0a3622fa2faaf46&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'email-queue/email-queue.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/email-queue/?k=e345e1b6623f0dca119bc2d9433b130b&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/email-queue/download/?k=e345e1b6623f0dca119bc2d9433b130b&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'limit-attempts/limit-attempts.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/limit-attempts/?k=b14e1697ee4d008abcd4bd34d492573a&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/limit-attempts/download/?k=b14e1697ee4d008abcd4bd34d492573a&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase' 		=> 'http://bestwebsoft.com/products/limit-attempts/buy/?k=9d42cdf22c7fce2c4b6b447e6a2856e0&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'job-board/job-board.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/job-board/?k=b0c504c9ce6edd6692e04222af3fed6f&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/job-board/download/?k=b0c504c9ce6edd6692e04222af3fed6f&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'multilanguage/multilanguage.php' => array(
				...
				'link'			=> 'http://bestwebsoft.com/products/multilanguage/?k=7d68c7bfec2486dc350c67fff57ad433&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'download'		=> 'http://bestwebsoft.com/products/multilanguage/download/?k=7d68c7bfec2486dc350c67fff57ad433&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
		...
		if ( $wp_version < '3.4' && ! isset( $_GET['action'] ) ) {
			$_GET['action'] = 'plugins';
		}
		...
		if ( isset( $_GET['action'] ) && 'system_status' == $_GET['action'] ) {
			...
			if ( isset( $get_theme ) )
				$system_info['system_info'][ __( 'Active Theme', 'bestwebsoft' ) ] = $get_theme['Name'] . ' ' . $get_theme['Version'];
		...
		<div class="wrap">
			...
			<h2>
				...
				<ul class="subsubsub bws_title_menu">
					...
					<li><a class="bws_system_status <?php if ( isset( $_GET['action'] ) && 'system_status' == $_GET['action'] ) echo ' nav-tab-active'; ?>" href="admin.php?page=bws_themes&amp;action=system_status"><?php _e( 'System status', 'bestwebsoft' ); ?></a></li>
				</ul>
				<div class="clear"></div>
			</h2>			
			<h2 class="nav-tab-wrapper">
				<?php if ( $wp_version >= '3.4' ) { ?>
					<a class="nav-tab<?php if ( !isset( $_GET['action'] ) || ( isset( $_GET['action'] ) && 'themes' == $_GET['action'] ) ) echo ' nav-tab-active'; ?>" href="admin.php?page=bws_themes&amp;action=themes"><?php _e( 'Themes', 'bestwebsoft' ); ?></a>
				<?php } ?>
				<a class="nav-tab<?php if ( isset( $_GET['action'] ) && 'plugins' == $_GET['action'] ) echo ' nav-tab-active'; ?>" href="admin.php?page=bws_themes&amp;action=plugins"><?php _e( 'Plugins', 'bestwebsoft' ); ?></a>
			</h2>			
			<?php if ( isset( $_GET['action'] ) && 'plugins' == $_GET['action'] ) { ?>				
				<ul class="subsubsub">
					<li><a <?php if ( !isset( $_GET['sub'] ) ) echo 'class="current" '; ?>href="admin.php?page=bws_themes&amp;action=plugins"><?php _e( 'All', 'bestwebsoft' ); ?></a></li> |
					<li><a <?php if ( isset( $_GET['sub'] ) && 'installed' == $_GET['sub'] ) echo 'class="current" '; ?>href="admin.php?page=bws_themes&amp;action=plugins&amp;sub=installed"><?php _e( 'Installed', 'bestwebsoft' ); ?></a></li> |
					<li><a <?php if ( isset( $_GET['sub'] ) && 'recommended' == $_GET['sub'] ) echo 'class="current" '; ?>href="admin.php?page=bws_themes&amp;action=plugins&amp;sub=recommended"><?php _e( 'Recommended', 'bestwebsoft' ); ?></a></li>
				</ul>
				<div class="clear"></div>
								...
								<div class="bws_product">				
									...
									<div class="bws_product_content">
										<div class="bws_product_icon">
											...
											<img src="<?php echo $path . "icons/" . $icon . '.png'; ?>"/>												
										</div>			
			...
			<?php } elseif ( ! isset( $_GET['action'] ) || ( isset( $_GET['action'] ) && 'themes' == $_GET['action'] ) ) { ?>	
			...
			<?php } elseif ( 'system_status' == $_GET['action'] ) {	?>
				...
				<div class="inside">
					...
					<div class="clear"></div>						
					<form method="post" action="admin.php?page=bws_themes&amp;action=system_status">
						<p>			
...
if ( ! function_exists ( 'bws_themes_init' ) ) {
	function bws_themes_init() {
		/* Internationalization */
		load_theme_textdomain( 'bestwebsoft', get_template_directory() . '/bws_menu/languages/' );
	}
}

if ( ! function_exists ( 'bws_themes_admin_enqueue_scripts' ) ) {
	function bws_themes_admin_enqueue_scripts() {
...
if ( ! function_exists ( 'bws_themes_admin_head' ) ) {
	function bws_themes_admin_head() {
		if ( isset( $_GET['page'] ) && $_GET['page'] == "bws_themes" ) { ?>
			<noscript>
				<style type="text/css">
					.bws_product_button {
...
add_action( 'admin_init', 'bws_themes_init' );
add_action( 'admin_enqueue_scripts', 'bws_themes_admin_enqueue_scripts' );
add_action( 'admin_head', 'bws_themes_admin_head' );
?>